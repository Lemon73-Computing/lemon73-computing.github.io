...
>> <summary>原文:</summary>
>> 
>> Hello! Yes, I can provide some information about Lemon73. It appears to be associated with various activities, including coding, design, and video editing. Here are some key points about Lemon73:
>> 1. Lemon73 Blog: This platform seems to feature updates and plans, such as the release of "Alice Novel v0.9.3" and discussions about the Lemon73 Festival and other events.
>> 1. YouTube Channel: Lemon73 hosts a channel that organizes festivals, including the Lemonade Flash and Lemon Flower Day, which are part of a series referred to as the LF series.
>> 1. Lemon's Resting Area: This is a community or platform where Lemon73 is involved, focusing on various skills like HTML, CSS, and .NET (C#).
>> 1. GitHub Profile: Lemon73 has a presence on GitHub, showcasing skills in programming and contributions to projects, particularly in the KDE community.
>> 
>> If you have any specific questions or need more detailed information about Lemon73, feel free to ask!
>> </details>
...
>> <summary>原文:</summary>
>> 
>> Thanks for these pretty good information. Okay, next question, do you know the Alice Novel that created by Lemon73?
>> </details>
...
>> <summary>原文:</summary>
>> 
>> Yes, the Alice Novel created by Lemon73 is a free, open-source, and cross-platform game engine designed for creating visual novels. Here are some key points about it:
>> 1. Purpose: The Alice Novel engine allows users to create interactive storytelling experiences, making it accessible for both beginners and experienced developers.
>> 1. Features:
>>     - User-Friendly Interface: It provides a great user interface that simplifies the game development process.
>>     - Script-Based: The engine supports easy script-based programming, enabling creators to implement complex narratives and gameplay mechanics.
>> 1. Community and Support: Being open-source, it encourages collaboration and contributions from developers, fostering a community around visual novel creation.
>> 1. Cross-Platform: The engine is designed to work across different platforms, making it versatile for various devices.
>> 
>> If you have any specific questions about the Alice Novel engine or its features, feel free to ask!
>> </details>
...
やはり、メモリ機能はないほうが精度が高いですね。(おそらく、中立性も高いし)
...
Alice Novel は Linux は現状対応していないのですが、Alice Console の Linux 対応情報から、記載しているのかな、と思っています。まあ、誤情報ですが。

Anov の説明はかなり詳しいです。

Alice Edit は確か、Lemon's Resting Area の公式サイトに記載していた気がしますが、特に作る気はないです。
</details>
